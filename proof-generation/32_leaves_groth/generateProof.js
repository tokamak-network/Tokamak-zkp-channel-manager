...
async function generateProof() {
    try {
        ...
        execSync('snarkjs wtns calculate ../circuit_N5_js/circuit_N5.wasm input.json witness.wtns', {
            stdio: 'inherit',
            cwd: process.cwd()
        });
        ...
        execSync('snarkjs groth16 prove ../zkey/circuit_final_32.zkey witness.wtns proof.json public_temp.json', {
            stdio: 'inherit',
            cwd: process.cwd()
        });
        ...
        const wasm = fs.readFileSync('../circuit_N5_js/circuit_N5.wasm');
        const witnessCalculator = require('../circuit_N5_js/witness_calculator.js');
...
function checkRequiredFiles() {
    const requiredFiles = [
        '../circuit_N5_js/circuit_N5.wasm',
        'input.json',
        '../zkey/circuit_final_32.zkey'
    ];
