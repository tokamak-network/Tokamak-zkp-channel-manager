...
async function generateProof() {
    try {
        ...
        execSync('snarkjs wtns calculate ../circuit_N6_js/circuit_N6.wasm input.json witness.wtns', {
            stdio: 'inherit',
            cwd: process.cwd()
        });
        ...
        execSync('snarkjs groth16 prove ../zkey/circuit_final_64.zkey witness.wtns proof.json public_temp.json', {
            stdio: 'inherit',
            cwd: process.cwd()
        });
        ...
        const wasm = fs.readFileSync('../circuit_N6_js/circuit_N6.wasm');
        const witnessCalculator = require('../circuit_N6_js/witness_calculator.js');
...
function checkRequiredFiles() {
    const requiredFiles = [
        '../circuit_N6_js/circuit_N6.wasm',
        'input.json',
        '../zkey/circuit_final_64.zkey'
    ];
...
if (require.main === module) {
    console.log('🚀 Tokamak ZK Proof Generator (64 Leaves)');
    console.log('==========================================\n');
