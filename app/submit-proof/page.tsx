      ...
      <div className={`flex-1 ${sidebarCollapsed ? 'lg:ml-16' : 'lg:ml-64'} flex flex-col min-h-screen transition-all duration-300`}>
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Submit Aggregated Proof</h1>
              <p className="text-gray-600 dark:text-gray-400">Submit your channel's aggregated proof to the network</p>
            </div>
          ...
          {!isConnected ? (
            ...
            <div className="max-w-4xl mx-auto">
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Submit Proof Feature</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  This feature allows channel leaders to submit aggregated proofs to the network
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-500">
        ...
        <footer className="mt-auto bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 px-6 py-8">
          <div className="max-w-6xl mx-auto">
            <div className="flex flex-wrap justify-center gap-6 mb-6">
              ...
              <a href="https://medium.com/onther-tech" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a href="https://www.linkedin.com/company/onther-inc/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-gray-600 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
