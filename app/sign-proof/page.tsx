          ...
          {!isConnected ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Please connect your wallet to sign aggregated proof
              </p>
            </div>
          ) : !hasAccess ? (
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-500">
                You need to be a channel leader to sign aggregated proofs
              </p>
            </div>
          ) : (
            <div className="max-w-4xl mx-auto">
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Sign Proof Feature</h3>
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  This feature allows channel leaders to sign aggregated proofs
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-500">
